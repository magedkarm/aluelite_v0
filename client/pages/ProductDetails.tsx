...
export default function ProductDetails() {
  ...
  const prevImage = () => {
    const prevIndex =
      (modalImageIndex - 1 + product.images.length) % product.images.length;
  ...
  const productData: Record<string, any> = {
    "1": {
      ...
      description:
        "أنظمة فواصل مكتبية عصرية وعملية للمساحات التجارية والإدارية",
      images: [
      ...
      systems: [
        {
          name: "نظام زجاج مغشي",
          description:
            "يمنح الزجاج مظهراً أنيقاً ويولد بيئة عمل مفتوحة ومشرقة مع العزل الصوتي",
          features: [
        ...
        },
        {
          name: "النظام الخشبي",
          description:
            "تشكيلة كبيرة من الأنواع الخشبية مع عزل صوتي وحراري ممتاز",
          features: [
